import { OutgoingMessage, SupportedMessage as OutgoingSupportedMessages } from "./messages/outgoingMessages.js";
...
function messageHandler(ws: connection, message: IncomingMessage) {
    ...
    if (message.type === SupportedMessage.SendMessage) {
        ...
        userManager.broadcast(payload.roomId, payload.userId, JSON.stringify(outgoingPayload)); // matches signature
    }
